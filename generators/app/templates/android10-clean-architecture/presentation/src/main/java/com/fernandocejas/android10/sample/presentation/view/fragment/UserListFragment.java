...
import <%= appPackage %>.presentation.internal.di.components.UserComponent;
import <%= appPackage %>.presentation.model.UserModel;
import <%= appPackage %>.presentation.presenter.UserListPresenter;
import <%= appPackage %>.presentation.view.UserListView;
import <%= appPackage %>.presentation.view.adapter.UsersAdapter;
import <%= appPackage %>.presentation.view.adapter.UsersLayoutManager;
