...
import <%= appPackage %>.data.entity.mapper.UserEntityDataMapper;
import <%= appPackage %>.data.repository.datasource.UserDataStore;
import <%= appPackage %>.data.repository.datasource.UserDataStoreFactory;
