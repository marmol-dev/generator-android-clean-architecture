 ...
 */
package <%= appPackage %>.data.repository.datasource;

import android.content.Context;
import android.support.annotation.NonNull;
import <%= appPackage %>.data.cache.UserCache;
import <%= appPackage %>.data.entity.mapper.UserEntityJsonMapper;
import <%= appPackage %>.data.net.RestApi;
import <%= appPackage %>.data.net.RestApiImpl;
