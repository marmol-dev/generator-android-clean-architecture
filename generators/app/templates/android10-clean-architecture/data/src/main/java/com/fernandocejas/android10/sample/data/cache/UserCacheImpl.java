 ...
 */
package <%= appPackage %>.data.cache;

import android.content.Context;
import <%= appPackage %>.data.cache.serializer.Serializer;
import <%= appPackage %>.data.entity.UserEntity;
import <%= appPackage %>.data.exception.UserNotFoundException;
...
public class UserCacheImpl implements UserCache {
  ...
  private static final String SETTINGS_FILE_NAME = "<%= appPackage %>.SETTINGS";
